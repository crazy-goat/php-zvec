--TEST--
SEC-004: Null pointer checks — schema/index/query handle functions handle null without segfault
--SKIPIF--
...
?>
--EXPECTF--
PASS: Starting null handle tests for schema/query/stats
PASS: zvec_schema_free(null) is no-op
PASS: zvec_vector_query_free(null) is no-op
PASS: zvec_group_by_vector_query_free(null) is no-op
PASS: zvec_index_params_free(null) is no-op
PASS: zvec_collection_stats_free(null) is no-op
PASS: zvec_field_schema_free(null) is no-op
PASS: zvec_batch_result_free(null) is no-op
PASS: zvec_query_result_free(null) is no-op
PASS: zvec_group_results_free(null) is no-op
PASS: zvec_collection_stats_get_doc_count(null)=0
PASS: zvec_collection_stats_get_index_count(null)=0
PASS: zvec_collection_stats_get_index_name(null)=NULL
PASS: zvec_field_schema_get_name(null)=NULL
PASS: zvec_field_schema_get_data_type(null)=0
PASS
