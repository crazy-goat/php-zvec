--TEST--
Memory leak: init error path frees C allocations
--SKIPIF--
...
Re-init after error OK
20x error/recovery cycles OK (delta: %d bytes)
PASS: Init error path does not leak C allocations
